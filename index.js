...
document.getElementById("about-me-menu-item").addEventListener("dblclick", function() {
    document.getElementById("about-me-popup-window").style.display = "block";
});

document.getElementById("things-i-hate-menu-item").addEventListener("dblclick", function() {
    document.getElementById("things-i-hate-popup-window").style.display = "block";
});